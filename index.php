    ...
    <section id="hero" class="text-center p-5 bg-info-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/p2/222/2024/08/18/WhatsApp-Image-2024-08-17-at-140220-4284981413.jpeg" class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          ...
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15343</h3>
            <h1 class="fw-bold">AISYA NUR SYAKBANI</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>AISYA NUR SYAKBANI &copy; 2023</div>
    </footer>
    <!-- footer end -->
